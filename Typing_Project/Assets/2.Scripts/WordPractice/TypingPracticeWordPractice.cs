...
public class TypingPracticeWordPractice : MonoBehaviour, ITypingPractice
{
    ...
    public TextMeshProUGUI displayText;             // 화면에 주어지는 단어 Text
    public TMP_InputField inputField;               // 사용자 입력 필드
    public TextMeshProUGUI nextDisplayText;         // 다음 단어 미리보기 Text
    public TextMeshProUGUI leftText;                // 남은 단어 카운트 Text
